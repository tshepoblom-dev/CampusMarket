                ...
                <div class="col-xl-6 col-lg-8 col-md-10">
                    <div class="form-wrapper wow fadeInUp" data-wow-duration="1.5s" data-wow-delay=".2s">
                        <div class="form-title">
                            <h3>{{ translate('Become a Merchant') }}</h3>
                            <p>{{ translate('Do you already have an account?') }} <a
                                    href="{{ url('login') }}">{{ translate('Log in here') }}</a></p>
                        </div>
                        <form class="w-100 register-form" action="{{ route('merchant.register') }}" method="post">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-12">
                                    <div class="form-inner">
                                        ...
                                        <input type="text" id="shop_name" value="{{ old('shop_name') }}"
                                ...
                                <div class="col-md-12">
                                    <div class="form-agreement form-inner d-flex justify-content-between flex-wrap">
                                        <div class="form-group">
                                            ...
                                            <label
                                                for="terms_policy">{{ translate('I agree to the Terms & Policy') }}</label><br>
