                    ...
                    <tbody>
                        @foreach ($categories as $key => $category)
                            <tr>
                                ...
                                <td data-label="Product">{{ $category->products->count() }}</td>
                                <td data-label="Status">
                                    <span id="statusBlock{{ $category->id }}">
                                ...
                                <td data-label="Published">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input flexSwitchCheck" type="checkbox"
                                            data-activations-status="{{ $category->status }}"
                                            data-category-id="{{ $category->id }}" id="flexSwitchCheck{{ $category->id }}"
                                ...
                                <td data-label="Language">
                                    @foreach (\App\Models\Language::all() as $key => $language)
                                        ...
                                        @else
                                            <a
                                                href="{{ route('category.edit', ['id' => $category->id, 'lang' => $language->code]) }}"><i
                                ...
                                <td data-label="Option">
                                    <div
                                        ...
                                        <a class="eg-btn add--btn"
                                            href="{{ route('category.edit', ['id' => $category->id, 'lang' => get_setting('DEFAULT_LANGUAGE', 'en')]) }}"><i
