        ...
        <div class="accordion-collapse collapse ">
            <div class="accordion-body">
                ...
                <form enctype="multipart/form-data" data-action="{{ route('pages.widget.save') }}" class="form"
                        ...
                        <div class="col-sm-12 mb-2">
                            <div class="form-inner">
                                ...
                                <input type="text" class="username-input"
                                    ...
                                    name="content[0][testimonial_main_title]"
                                    value="{{ isset($widgetContents['testimonial_main_title']) ? $widgetContents['testimonial_main_title'] : '' }}">
                            </div>
                        </div>
                        <div class="col-sm-12 mb-2">
                            <div class="form-inner">
                                ...
                                <textarea class="username-input" placeholder="{{ translate('Enter Main Description') }}"
                                    name="content[0][testimonial_main_descriptions]">{{ isset($widgetContents['testimonial_main_descriptions']) ? $widgetContents['testimonial_main_descriptions'] : '' }}</textarea>
                            </div>
                        </div>
                    </div>
                    <div class="testimonials-area">

                        @if (isset($widgetContents['testimonials']))
                            @php
                                $count = 0;
                            @endphp
                            @foreach ($widgetContents['testimonials'] as $key => $testimonial)
                                @php
                                ...
                                <div class="row align-items-center content">
                                    <div class="col-sm-11">
                                        <div class="row">
                                            <div class="col-sm-3 mb-2">
                                                <div class="form-inner">
                                                    ...
                                                    <input type="text" class="username-input"
                                                        ...
                                                        name="content[0][testimonials][{{ $count }}][testimonial_name]"
                                                        value="{{ isset($testimonial['testimonial_name']) ? $testimonial['testimonial_name'] : '' }}">
                                                </div>
                                            </div>
                                            <div class="col-sm-4 mb-2">
                                                <div class="form-inner">
                                                    @php
                                                    $contentDescript= isset($testimonial['testimonial_designations']) ?   $testimonial['testimonial_designations']  : '';
                                                  ...
                                                  @endphp
                                                    ...
                                                    <input type="text" class="username-input"
                                                        ...
                                                        value="{{$contentDescript}}"
                                                        name="content[0][testimonials][{{ $count }}][testimonial_designations]">
                                            ...
                                            <div class="col-sm-5 mb-2">
                                                <div class="form-inner">
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <input type="hidden"
                                                            name="content[0][testimonials][{{ $count }}][img]"
                                                            id="old_file"
                                                            value="{{ isset($testimonial['img']) ? $testimonial['img'] : '' }}">

                                                        @if (isset($testimonial['img']))
                                                            <div class="ms-2">
                                                                <img height="40" width="auto"
                                                                    src="{{ asset('uploads/testimonials/' . $testimonial['img']) }}"
                                                                    alt="">
                                                            </div>
                                                        @endif
                                                    </div>
                                            ...
                                            <div class="col-sm-12 mb-2">
                                                @php
                                                $testimonial_descriptions= isset($testimonial['testimonial_descriptions']) ?   $testimonial['testimonial_descriptions']  : '';
                                                $testimonial_descriptions=  html_entity_decode($testimonial_descriptions);
                                                $testimonial_descriptions=  prelaceScript($testimonial_descriptions);
                                              @endphp
                                                <div class="form-inner">
                                                    <label>{{ translate('Description') }}</label>
                                                    <textarea name="content[0][testimonials][{{ $count }}][testimonial_descriptions]"> {{$testimonial_descriptions}}  </textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="add-row">
                        <button type="button" class="add-testimonials-btn eg-btn btn--primary back-btn">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 mb-2">
                            <div class="form-inner">
                                <label>{{ translate('Description') }}</label>
                                <textarea class="username-input" placeholder="{{ translate('Enter Main Description') }}"
                                    name="content[0][testimonial_main_descriptions]"></textarea>
                            </div>
                        </div>
                    </div>
