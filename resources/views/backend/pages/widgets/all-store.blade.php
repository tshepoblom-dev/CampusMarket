                        ...
                        <div class="col-sm-6 mb-2">
                            <div class="form-inner">
                                ...
                                <select class="js-example-basic-single" name="content[0][order_by_blogs]">
                                    ...
                                    <option value="desc"
                                        {{ isset($widgetContents['order_by_blogs']) && $widgetContents['order_by_blogs'] == 'desc' ? 'selected' : '' }}>
                                        {{ translate('Descending') }}</option>
                                    <option value="asc"
                                        {{ isset($widgetContents['order_by_blogs']) && $widgetContents['order_by_blogs'] == 'asc' ? 'selected' : '' }}>
