                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4 mb-2">
                            <div class="form-inner">
                                ...
                                <input type="text" class="username-input"
                                    ...
                                    value="{{ isset($widgetContents['total_display_recent_news']) ? $widgetContents['total_display_recent_news'] : 2 }}">
                            </div>
                        </div>
                        <div class="col-sm-4 mb-2">
                            <div class="form-inner">
                        ...
                        <div class="col-sm-12 mb-2">
                            <div class="form-inner">
                                ...
                                <textarea name="content[0][recent_news_descriptions]"> {{ isset($widgetContents['recent_news_descriptions'])
                                    ? $widgetContents['recent_news_descriptions']
                                    : '' }}  </textarea>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4 mb-2">
                            <div class="form-inner">
                                ...
                                <input type="text" class="username-input"
                                    placeholder="{{ translate('Total Display Recent News') }}"
                                    name="content[0][total_display_recent_news]" value="2">
                            </div>
                        </div>
                        <div class="col-sm-4 mb-2">
                            <div class="form-inner">
                        ...
                        <div class="col-sm-12 mb-2">
                            <div class="form-inner">
                                <label>{{ translate('Description') }}</label>
                                <textarea name="content[0][recent_news_descriptions]"></textarea>
                            </div>
                        </div>
