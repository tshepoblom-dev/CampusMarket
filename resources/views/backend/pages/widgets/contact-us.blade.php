                    ...
                    <div class="row">
                        ...
                        {{-- <div class="col-sm-6  mb-3">
                            <div class="form-inner">
                                ...
                                <textarea type="text" rows="10" class="username-input" placeholder="{{ translate('Enter Iframe Code') }}" name="content[0][irame_link]">{{ isset($widgetContents['irame_link']) ? $widgetContents['irame_link'] : '' }} </textarea>
                            </div>
                        </div> --}}
