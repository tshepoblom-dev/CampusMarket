                ...
                <div class="row">
                    <div class="col-sm-12 mb-2">
                        <div class="form-inner">
                            ...
                            <input
                                 ...
                                 name="content[0][text_editor_title]"
                                 value="{{isset($widgetContents['text_editor_title'])? $widgetContents['text_editor_title'] :''}}">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12 mb-2">
                        <div class="form-inner">
                            ...
                            <textarea name="content[0][text_editor_descriptions]"> {{ isset( $widgetContents['text_editor_descriptions'] ) ?  $widgetContents['text_editor_descriptions'] :'' }}  </textarea>
                        </div>
                    </div>
            ...
            <form enctype="multipart/form-data"  data-action="{{route('pages.widget.save')}}" class="form" method="POST">
                ...
                <div class="col-sm-12 mb-2">
                    ...
                    <div class="col-sm-12 mb-2">
                        <div class="form-inner">
                            <label>{{translate('Description')}}</label>
                            <textarea name="content[0][text_editor_descriptions]"></textarea>
                        </div>
                    </div>
                </div>
