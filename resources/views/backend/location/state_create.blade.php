...
@section('content')
    <div class="row mb-35 g-4">
        <div class="col-md-6 d-flex">
            <div class="page-title text-md-start text-center">
                <h4>{{ $countrySingle->name }} - {{ $page_title ?? '' }}</h4>

            </div>

        </div>
        <div class=" col-md-6 text-md-end text-center d-flex justify-content-md-end justify-content-center flex-row align-items-center flex-wrap gap-4">
    ...
    <form action="{{ route('state.store', $countrySingle->id) }}" method="post">
        @csrf
        <div class="row">
