...
class Kernel extends HttpKernel
{
    ...
    protected $middleware = [
        ...
        \App\Http\Middleware\IntallerValid::class,
    ...
    protected $middlewareAliases = [
        ...
        'backend' => \App\Http\Middleware\IsBackend::class,
        ...
        // 'IntallerValid' => \App\Http\Middleware\IntallerValid::class,
        'pverify' => \App\Http\Middleware\PurchaseVerify::class,
    ];
}
